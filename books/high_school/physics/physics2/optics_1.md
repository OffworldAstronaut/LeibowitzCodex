...
Esse fenômeno será tratado com mais detalhes em outro documento (<a href="/books/high_school/physics/physics2/optics_2.html">Fundamentos da Óptica Geométrica II — Refração e Lentes</a>).
...
**I — Princípio da Propagação da Luz**: Em meios transparentes e homogêneos, os raios de luz propagam-se sempre em linha reta.

</aside>

<aside>

**II — Princípio da Independência dos Raios de Luz**: Os raios de luz que se cruzam mantém sua trajetória e características originais. 

</aside>

<aside>

**III — Princípio da Reversibilidade**: A trajetória seguida pelos raios de luz, num sentido, é a mesma no sentido inverso. 
...
![*Diagrama de como um espelho côncavo funciona. Note que todos os raios vão para o mesmo ponto (”Focus”), independente de onde foram refletidos. Imagem original.*](https://upload.wikimedia.org/wikipedia/commons/b/bc/Concave_Mirror_Diagram.png)
...
![*Exemplo de imagem num espelho plano. A imagem é virtual pois os raios não “passam” pela imagem realmente, mas parecem estar vindo dela. Imagem licenciada sob CC-BY, via [openstax.org](http://openstax.org/).* ](./images/optics_1/flat_mirror.jpeg)
...
> *“Num espelho esférico, toda imagem real é invertida e toda imagem invertida é real. Em um espelho esférico, também, toda imagem virtual é direita, e toda imagem direita é virtual.” ([Guia do Estudante, Editora Abril](https://guiadoestudante.abril.com.br/curso-enem-play/espelhos-esfericos/))*
> 
...
![*Ilustração do cenário acima. Imagem sob CC-BY-SA, via Wikimedia Commons.*](https://upload.wikimedia.org/wikipedia/commons/d/d2/Concavemirror_raydiagram_2F.svg)

<i>Ilustração do cenário acima. Imagem sob CC-BY-SA, via <a href="https://commons.wikimedia.org/wiki/File:Concavemirror_raydiagram_2F.svg">Wikimedia Commons</a>.</i>
...
- Num espelho côncavo (convergente), $f > 0$;
    - Logo, num espelho convexo, $f<0$;
- Numa imagem real, $p'>0$;
    - Logo, numa imagem virtual, $p'<0$;
...
- Se a imagem é direita, $A>0$;
    - Logo, se a imagem é invertida, $A<0$;
- Se a imagem é ampliada, $|A|>1$;
    - Logo, se a imagem é reduzida, $|A|<1$;
- Por fim, se a imagem possui tamanho inalterado em relação ao objeto, $A=1$.