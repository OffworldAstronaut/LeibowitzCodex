...
Quanto mais **acima** na série um material está, ele tem uma maior tendência de **perder elétrons**, e quanto mais **abaixo** ele está, ele tem uma maior tendência de **ganhar elétrons** ao ser atritado. À medida que atritamos materiais cada vez mais distantes entre si na série triboelétrica, mais elétrons vão ser transferidos entre esses corpos. 
